...
/**
 * @file
 * @brief TI SimpleLink CC13X2/CC26X2 RTC-based system timer
 *
...
#include <ti/devices/cc13x2_cc26x2/driverlib/aon_event.h>
...
#define CYCLES_PER_TICK (RTC_COUNTS_PER_TICK / RTC_COUNTS_PER_CYCLE)

/* Maximum number of ticks. */
#define MAX_TICKS (UINT32_MAX / CYCLES_PER_TICK)
...
static void rtc_isr(void *arg)
{
	...
	/* update saved threshold counter */
